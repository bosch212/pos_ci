            ...
            <div class="row clearfix">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-red">
                        ...
                        <div class="content">
                            <div class="font-14">PO Hari Ini</div>
                            <div class="font-16">120</div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-cyan">
                        ...
                        <div class="content">
                            <div class="font-14">Dana Belum Masuk</div>
                            <div class="font-16">12</div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-light-green">
                        ...
                        <div class="content">
                            <div class="font-14">Uang Hari Ini</div>
                            <div class="font-16">Rp.12.000.000</div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-orange">
                        ...
                        <div class="content">
                            <div class="font-14">Ayam Hari Ini</div>
                            <div class="font-16">20 ekor</div>
                            <div class="font-16">60 Kg</div>
                        </div>
                    </div>
                </div>
            </div>
